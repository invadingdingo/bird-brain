...
public class TileMovementController : MonoBehaviour {
    ...
    private void HandleMovement() {
    	// DownCast
        downCast = Physics2D.Raycast(new Vector3(transform.position.x, 0, transform.position.z - distanceToMove), new Vector3(0, 0, 1), distanceToMove);
        Debug.DrawRay(new Vector2(transform.position.x, transform.position.y - distanceToMove), new Vector3(0, 0, 1) * distanceToMove, Color.red);

        // UpCast
        upCast = Physics2D.Raycast(new Vector2(transform.position.x, transform.position.y - distanceToMove), Vector2.up, distanceToMove);
        Debug.DrawRay(new Vector2(transform.position.x, transform.position.y - distanceToMove), Vector2.up * distanceToMove, Color.green);
        ...
        Debug.DrawRay(new Vector2(transform.position.x, transform.position.y - distanceToMove), -Vector2.right * distanceToMove, Color.blue);
        ...
        Debug.DrawRay(new Vector2(transform.position.x, transform.position.y - distanceToMove), Vector2.right * distanceToMove, Color.yellow);
